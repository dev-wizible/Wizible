...
export function validateConfig(): void {
  ...
  console.log(`   • Extractions: ${config.concurrent.extraction} concurrent (reduced for rate limiting)`);
  console.log(`   • Scoring: ${config.concurrent.scoring} concurrent`);
  console.log(`   • Validation: ${config.concurrent.validation} concurrent`);
  console.log(`   • LlamaIndex delay: ${config.rateLimit.llamaDelay}ms between calls`);
  console.log(`   • Retry attempts: ${config.retries.maxAttempts} with exponential backoff`);
